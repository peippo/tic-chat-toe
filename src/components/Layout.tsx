    ...
    <>
      ...
      >
        <div className="relative overflow-hidden rounded-3xl border-x-2 border-b-[12px] border-t-2 border-x-purple-500 border-b-purple-800 border-t-purple-600 bg-purple-700 bg-gradient-to-t from-purple-400 via-purple-600 via-15% to-purple-800 px-8 pt-4 shadow-2xl shadow-purple-950">
          <div className="pointer-events-none absolute -top-80 right-40 z-20 h-[512px] w-40 rotate-45 bg-gradient-to-t from-cyan-400 via-cyan-500 via-10% to-slate-600 to-70% opacity-30 mix-blend-lighten"></div>
          <div className="pointer-events-none absolute -top-72 right-40 z-20 h-[512px] w-60 rotate-45 bg-gradient-to-t from-cyan-400 via-cyan-500 via-30% to-slate-600 to-80% opacity-20 mix-blend-lighten"></div>
          ...
          <div className="rounded-br-4xl relative rounded-xl rounded-bl-3xl border-b-2 border-b-purple-400 bg-gray-900 px-4 pb-1 pt-4">
            ...
            <p className="pointer-events-none text-center text-lg tracking-tight text-slate-400">
